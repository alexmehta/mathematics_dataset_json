...
flags.DEFINE_integer('per_train_module', 5 * THOUSAND,
                     'Num of examples per train module')
flags.DEFINE_integer('per_test_module', 5 * THOUSAND,
                     'Num of examples per test module')
...
def init_modules(train_split=False):
    ...
    counts['train-medium'] = FLAGS.per_train_module
    counts['train-hard'] = FLAGS.per_train_module
